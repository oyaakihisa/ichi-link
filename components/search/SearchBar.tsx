...
const INPUT_TYPES: {
  ...
  { value: "wgs84", label: "世界測地", placeholder: "35.6812, 139.7671" },
  { value: "tokyo", label: "旧日本測地", placeholder: "35.6812, 139.7671" },
];
...
export function SearchBar({ onConvert, isLoading = false }: SearchBarProps) {
  ...
  const currentType =
    INPUT_TYPES.find((t) => t.value === inputType) || INPUT_TYPES[0];
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg px-2 py-1">
      {/* 入力タイプ選択（常時展開） */}
